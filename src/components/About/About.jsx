...
const About = () => {
    ...
    return (
        <section id="about" ref={aboutRef} className="relative w-full h-screen flex items-center justify-end text-white">
            <style>
                {`
            ...
            <div className="relative w-2/3 md:w-2/5 lg:w-1/3 p-5 rounded-lg text-gray-900 m-5 fade-in">
                <h2 className="text-4xl font-bold text-gray-900 underline pb-4 dancing-script">Về chúng tôi</h2>
                <p className="mb-5">
